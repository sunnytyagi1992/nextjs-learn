...
//             const [logmessage, setLogMessage] = useState('alreadyLogged')
//             }
//         else {
...
//                                 <label htmlFor="userrname" className="block mb-2 text-sm font-medium text-indigo-700 dark:text-white">Your Name</label>
//                                 <input onChange={(e) => setFormData({ ...formData, username: e.target.value })} type="text" name="username" id="name" className="bg-indigo-50 border border-indigo-300 text-indigo-700 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-indigo-700 dark:border-indigo-600 dark:placeholder-indigo-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Abdullah Moiz" required="" />
//                             </div>
...
//                                   <Link href="/" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign In</Link>
//                             </p>
//                         </form>
//                     </div>
//                 </div>
